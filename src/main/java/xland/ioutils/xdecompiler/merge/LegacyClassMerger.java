...
@Deprecated
public class LegacyClassMerger implements ClassMerger {
    ...
    public LegacyClassMerger() {
    }

    public byte @NotNull [] merge(byte[] clientClass, byte[] serverClass) {
        Objects.requireNonNull(clientClass, "clientClass");
        Objects.requireNonNull(serverClass, "serverClass");
        ...
        // why don't we directly output based on nodeC
